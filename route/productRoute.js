...
const { addProduct, productList, productDetails, productByCategory, updateProduct, deleteProduct, filterProduct, findRelated } = require('../controller/productController')
